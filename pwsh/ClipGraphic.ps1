function Save-ClipboardAsGraphic {
    ...
    function New-ResourceContainer {
        # Needed for ``-ErrorAction SilentyContinue``
        [CmdletBinding()]
        Param(
            [String]
...
# # (karlr 2025-11-28): [RTFM]: I see no practical use for this tool. It also doesn't seem to belong here. It also is not being used by any other modules.
