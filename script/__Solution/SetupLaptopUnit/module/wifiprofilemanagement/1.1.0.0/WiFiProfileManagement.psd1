...
@{
    ...
    FunctionsToExport = @('Connect-WiFiProfile','Get-WiFiAvailableNetwork','Get-WiFiProfile','New-WiFiProfile','Remove-WiFiProfile','Search-WiFiNetwork','Set-WifiInterface','Set-WiFiProfile')
